      ...
      <section className="py-24 px-6 bg-background">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {catalogs.map((catalog, index) => <Card key={index} className="p-8 hover:shadow-elegant transition-all duration-300">
                <div className="mb-4">
      ...
      <section className="py-24 px-6 bg-background">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {samples.map((sample, index) => <Card key={index} className="p-8 hover:shadow-elegant transition-all duration-300">
                <h3 className="font-playfair text-xl font-semibold text-primary mb-4">
                  {sample.title}
                </h3>
                <p className="font-inter text-muted-foreground mb-6 leading-relaxed">
